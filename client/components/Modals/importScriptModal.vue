    ...
    <div class="modal_window_i">
      <div class="mw_up modal-event-header">
        <div style="width: 100%; text-align: center;">
          <span class="modal-event-title">Импорт сценария</span>
          <br/>
          <span style="font-size: 15px;">{{importFilename}}</span>
        </div>
      ...
      <div class="modal-event-content ">
        <div class="description">
          ...
          <span>При установленной галочке - текущий сценарий будет удалён и заменён новымю.</span> <br/>
          <span>Если галочка не установлена - команды нового сценария добавятся к текущимю.</span>
        </div>
...
.modal-event-content .description {
  margin-top: 50px;
  margin-bottom: 30px;
  padding: 20px;
