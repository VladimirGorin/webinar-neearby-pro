...
export default {
  ...
  async mounted() { 
    ...
    if (!localStorage.getItem('token')) {
      ...
      console.log(this.isAutowebinar)
      if (this.isAutowebinar == false) {
        this.isAutowebinar = 0
      } else if (this.isAutowebinar == true) {
          ...
          if (key === 'screensaverPhoto' || key === 'screensaverAudio') {
            if (value) {
              ...
              if (key === 'screensaverPhoto') {
                ...
                this.screensaverPhotoUrl = this.$config.staticURL + '/' + value
  ...
  methods: {
    ...
    createStreamKey() {
      this.webinarData.source = this.generateString(9)
      console.log(this.webinarData.source)
    }, 
    clearModerator() {
      this.moderator = null
      this.moderatorText = ''
    ...
    async updateWebinar() {
      ...
      console.log("photooooooooooooooooooo", this.screensaverPhotoUrl)
      ...
      console.log(this.screensaverPhoto)
      console.log(this.screensaverPhotoUrl)
